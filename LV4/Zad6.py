...
df = pd.read_csv('C:/Users/brnar/Downloads/cars_processed.csv')
...
ax.set(xlabel='Predikcija', ylabel='Stvarna vrijednost', title='Rezultati na testnim podacima - s kategoričkim varijablama')
plt.show()
